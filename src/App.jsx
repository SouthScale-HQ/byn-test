...
import { CATEGORIES, COMPETITIONS, BOTS, COUNTRIES, FLAG_MAP, MIN_COMMIT_FRACTION, WEEKLY_TOPUP, SEASON_LENGTH_DEMO, AD_BOOST_PER_VIEW, AD_BOOST_MAX, MAX_MEMBERS,
  TEAM_POOL_EPL, TEAM_POOL_CHAMPIONSHIP, TEAM_POOL_LEAGUE_ONE, TEAM_POOL_LEAGUE_TWO, TEAM_POOL_NATIONAL_LEAGUE, TEAM_POOL_LA_LIGA, TEAM_POOL_UCL, TEAM_POOL_FIFA_WC, TEAM_POOL_EUROS,
  TEAM_POOL_SIX_NATIONS, TEAM_POOL_RUGBY_WC, TEAM_POOL_PREM_RUGBY, TEAM_POOL_URC, TEAM_POOL_SUPER_RUGBY, TEAM_POOL_NATIONS_CHAMP, TEAM_POOL_RUGBY_CHAMP, TEAM_POOL_NFL,
...
export default function PlatformMock() {
  ...
  async function signInWithGoogle() {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: "google",
      options: { redirectTo: "https://www.bynapp.online/app" },
    });
